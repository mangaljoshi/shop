				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-3">
							<h4 class="h4 mb-0"><strong>{{ optional(Auth::guard('admin')->user())->name }}</strong></h4>
                          <div class="mb-3">{{ optional(Auth::guard('admin')->user())->email }}</div>
							...
							<div class="dropdown-divider"></div>
							<a href="{{route('admin.logout')}}" method="POST" class="dropdown-item text-danger">
